...
public class ConversationController {
    ...
    @Operation(summary = "Client can create a new conversation by posting the Name of the conversation (wird nur erweitert)")
    @PostMapping("")
    public ResponseEntity<Long> postNewConversation(@RequestBody ConversationRequestDTO conversationRequestDTO) {
        return new ResponseEntity<>(conversationService.createConversation(conversationRequestDTO.conversationStartDate()).getId(), HttpStatus.OK);
    }
